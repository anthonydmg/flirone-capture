...
def create_csv(name_base = "fire_detection_",req_fields = ["presion", "alture", "alture_over_sea_level", "time", "visible_image", "thermal_image", "max_temperature", "area_fire", "latitud", "longitud"]):
    dir_path = "./registers"
...
def register_in_csv(name_file, data ,req_fields = ["presion", "alture", "alture_over_sea_level", "time", "visible_image", "thermal_image", "max_temperature", "area_fire", "latitud", "longitud"]):
